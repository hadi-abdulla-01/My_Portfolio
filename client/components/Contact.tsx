  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "5831b5fd-cea3-464d-a27c-2b821ba39d9e", // your Web3Forms key
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`w-full py-4 px-8 font-semibold tracking-wider border-t-2 border-b-2 border-black transition-colors ${
                  isSubmitting
